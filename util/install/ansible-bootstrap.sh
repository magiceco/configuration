...
# bash <(curl -s https://raw.githubusercontent.com/magiceco/configuration/master/util/install/ansible-bootstrap.sh)
...
if [[ -z "${CONFIGURATION_REPO}" ]]; then
  CONFIGURATION_REPO="https://github.com/magiceco/configuration.git"
fi
